 ...
 */
 ...
 class Freeware_posts extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array( 'classname' => 'widget-latest-posts', 'description' => __( 'Display Latest Posts/ Category', 'freeware') );
		$control_ops = array('width' => 200, 'height' => 250);
		parent::__construct( false, $name=__('T-Spiral: Latest Posts','freeware'), $widget_ops, $control_ops );
	...
	?>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'no_of_posts' )); ?>"><?php esc_html_e( 'Number of popular posts:', 'freeware' ); ?></label> 
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'posts_title' )); ?>"><?php esc_html_e( 'Title:', 'freeware' ); ?></label> 
		...
		<p><input type="radio" <?php checked(esc_attr($latest_posts), 'latest'); ?> id="<?php echo $this->get_field_id( 'latest_posts' ); ?>" name="<?php echo esc_attr($this->get_field_name( 'latest_posts' )); ?>" value="latest"/><?php _e( 'Latest Posts', 'freeware' );?>
			<br>
		 <input type="radio" <?php checked(esc_attr($latest_posts), 'category'); ?> id="<?php echo esc_attr($this->get_field_id( 'latest_posts' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'latest_posts' )); ?>" value="category"/><?php _e( 'Show Category posts', 'freeware' );?>
		</p>
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'category' )); ?>"><?php esc_html_e( 'Select category', 'freeware' ); ?>:</label>
			<?php wp_dropdown_categories( array( 'show_option_none' =>__('-- Select -- ','freeware'),'name' => esc_attr($this->get_field_name( 'category' )), 'selected' => esc_attr($category) ) ); ?>
		</p>
